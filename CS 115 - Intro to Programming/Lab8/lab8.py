...
Fibonacci = """
00 read r1       # Get n
01 setn r3 1     # initialize r3
02 jeqzn r1 9    # done if r1 is 0  
03 write r2      # print r2
04 add r4 r2 r3  # change r4 to r2 + r3 
05 copy r2 r3    # set r2 = r3
06 copy r3 r4    # set r3 = r4
07 addn r1 -1    # add -1 to r1 
08 jumpn 2       # repeat 
09 halt          # comes here to end when r1 = 0
""" 
